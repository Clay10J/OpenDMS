...
from opendms.core.security import (
    authenticate_user,
    create_access_token,
...
from opendms.schemas.user import UserResponse
...
async def refresh_token(
    ...
    from opendms.core.security import verify_token
...
async def register(
    ...
    Register a new user.
    """
    from opendms.crud.user import create_user, get_user_by_email
