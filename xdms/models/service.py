...
class ServiceAppointment(Base):
    ...
    # Service Information
    service_type = Column(String(100), nullable=True)  # maintenance, repair, warranty, etc.
    ...
    work_orders = relationship("ServiceWorkOrder", back_populates="appointment", cascade="all, delete-orphan")
...
class ServiceWorkOrder(Base):
    ...
    appointment_id = Column(Integer, ForeignKey("service_appointments.id"), nullable=False)
