// Service Worker for XDMS PWA
const CACHE_NAME = "xdms-v1.0.0";
const STATIC_CACHE = "xdms-static-v1.0.0";
const DYNAMIC_CACHE = "xdms-dynamic-v1.0.0";
...
self.addEventListener("push", (event) => {
  const options = {
    body: event.data ? event.data.text() : "New notification from XDMS",
  ...
  event.waitUntil(self.registration.showNotification("XDMS", options));
});
