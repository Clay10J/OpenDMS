...
from mdmsga.core.database import get_db
from mdmsga.core.security import (
    authenticate_user,
    create_access_token,
...
async def refresh_token(
    ...
    from mdmsga.core.security import verify_token
...
async def register(
    ...
    Register a new user.
    """
    from mdmsga.crud.user import create_user, get_user_by_email
