...
from mdmsga.api.v1.api import api_router
from mdmsga.core.config import settings
from mdmsga.core.database import Base, engine
from mdmsga.core.security import get_current_user
...
async def lifespan(app: FastAPI):
    # Startup
    print("Starting MDMSGA application...")
    yield
    # Shutdown
    print("Shutting down MDMSGA application...")
...
# Mount static files
app.mount("/static", StaticFiles(directory="mdmsga/static"), name="static")

# Templates
templates = Jinja2Templates(directory="mdmsga/templates")
...
if __name__ == "__main__":
    uvicorn.run("mdmsga.main:app", host="0.0.0.0", port=8000, reload=True)
