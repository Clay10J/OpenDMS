// Service Worker for MDMSGA PWA
const CACHE_NAME = "mdmsga-v1.0.0";
const STATIC_CACHE = "mdmsga-static-v1.0.0";
const DYNAMIC_CACHE = "mdmsga-dynamic-v1.0.0";
...
self.addEventListener("push", (event) => {
  const options = {
    body: event.data ? event.data.text() : "New notification from MDMSGA",
  ...
  event.waitUntil(self.registration.showNotification("MDMSGA", options));
});
