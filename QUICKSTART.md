# XDMS Quick Start Guide

Get XDMS running in minutes with this quick start guide.
...
4. **Create superuser**
   ...
   ```bash
   docker-compose exec api python -m xdms.cli create-superuser
   ```
...
XDMS includes a modern HTMX-based web interface that works on desktop and mobile devices.
...
2. **Login to get token**
   ...
   curl -X POST "http://localhost:8000/api/v1/auth/login" \
     ...
     -d "username=admin@xdms.com&password=password123"
   ```
